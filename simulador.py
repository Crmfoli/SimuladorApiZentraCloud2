...
# ===================================================================================
#   SIMULADOR WEB (VERSÃO 17.2 - AJUSTE NA TELA DE LOGIN)
#
#   - Atualiza a rota do mapa para refletir a mudança no formulário de login.
# ===================================================================================
...
def pagina_mapa():
    # Esta rota agora simplesmente renderiza o mapa,
    # já que a seleção do sensor é feita nele.
...
# ... (todas as rotas de API continuam aqui) ...
@app.route('/api/dados')
def api_dados():
    try:
        df = ler_dados_do_db();
